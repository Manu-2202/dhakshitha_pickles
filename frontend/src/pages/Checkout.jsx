...
export default function Checkout() {
  ...
  const initiateRazorpay = (orderId) =>
    new Promise((resolve, reject) => {
      ...
      rzp.on('payment.failed', (r) => reject(r.error));
      rzp.open();
    });
  ...
  const submitOrder = async (e) => {
    ...
    try {
      ...
      if (!rpRes.ok) throw new Error('Razorpay init failed');
      const rpOrder = await rpRes.json();

      // 2. Open Razorpay popup
      const payment = await initiateRazorpay(rpOrder.id);
      ...
      // 4. Save order — include wantsWhatsappUpdates from toggle
      const orderRes = await fetch(`${API_URL}/api/orders`, {
        ...
        body: JSON.stringify({
          ...
          discount,
          total: finalTotal,
          wantsWhatsappUpdates: wantsWhatsapp,   // ← saved to DB
          paymentDetails: {
      ...
      if (!orderRes.ok) throw new Error('Saving order failed');
      ...
      console.error(err);
      alert('Checkout failed: ' + (err.description || err.message));
    } finally {
  ...
  if (cart.length === 0 && !orderSuccess) {
    return (
      <div className="page-wrapper container" style={{ textAlign: 'center', marginTop: '50px' }}>
        <h2>Cart is empty.</h2>
      </div>
    );
  }
  ...
  // ── Success screen ──────────────────────────────────────────
  if (orderSuccess) {
    const trackID = orderSuccess.trackingId || `DP-${orderSuccess._id.slice(-6).toUpperCase()}`;
    return (
      <div className="page-wrapper checkout-page success-view luxury-overlay">
        <div className="container luxury-success-container">
          <div className="success-brand-header">
            ...
            <h2 className="success-h-luxury">Authenticity Unlocked!</h2>
            <p className="success-p-luxury">Your pickles are now being prepared with love and tradition.</p>
          </div>

          <div className="luxury-success-grid">
            <div className="luxury-tracking-result-card">
              <span className="ltr-label">TRACKING REFERENCE</span>
              ...
              <p className="ltr-footer">Use this ID to track your order in real-time.</p>
      ...
      <div className="container">
        ...
        <div className="checkout-coupon">
          ...
          <div style={{ display: 'flex', gap: '10px', marginTop: '10px' }}>
            ...
            />
            <button className="btn btn-secondary" onClick={applyCoupon}>APPLY COUPON</button>
          </div>
        ...
        <form className="checkout-grid" onSubmit={submitOrder}>
          ...
          <div className="checkout-form-card">
            ...
            <div className="checkout-form-body">
              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  <label>Phone *</label>
                  <input type="tel" name="phone" className="form-control" required onChange={handleInputChange} />
                </div>
              </div>
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input type="tel" name="altPhone" className="form-control" onChange={handleInputChange} />
                </div>
                <div className="form-group">
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: '0.8rem', color: '#888', marginTop: '2px' }}>
                        {wantsWhatsapp
                          ? 'You will get delivery status updates on WhatsApp.'
          ...
          <div className="order-summary-card">
            ...
            <div className="order-summary-body">
              ...
              {discount > 0 && (
                <div className="order-row" style={{ color: 'var(--primary)' }}>
              ...
              <div className="payment-note" style={{ marginTop: '20px', padding: '15px', background: '#f8f9fa', borderRadius: '8px' }}>
                <span style={{ fontSize: '1.2rem' }}>💳</span>
                <p style={{ margin: 0, textAlign: 'left', lineHeight: '1.4' }}>
                  Pay securely via Credit/Debit Card or NetBanking through Razorpay.
